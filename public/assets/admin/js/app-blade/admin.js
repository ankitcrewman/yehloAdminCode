...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('referal_form').addEventListener('submit', function (e) {
        var prefix = document.getElementById('referralPrefix').value.trim();
        if (prefix === '') {
            Swal.fire({
                title: "Warning",
                text: "Referral prefix is required.",
                icon: "warning"
            });
           e.preventDefault();
            return;
        ...
        document.getElementById('referralCode').value = prefix + randomString;
    });
});
