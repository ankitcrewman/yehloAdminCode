                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input id="fixed_footer_article_title" type="text" maxlength="180"
                                                ...
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Yehlo_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input id="web_app_url" type="text"
                                    placeholder="{{ translate('Ex: https://Yehlo-web.yehlo.com/') }}"
