    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                @php($banner_image_download = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'banner_image_download')->first())
                                                    ...
                                                    <label class="upload-img-3 m-0">
                                                        <div class="position-relative">
                                                            <div class="img">
                                                                ...
                                                                <img src="{{ asset('storage/app/public/promotion_banner') }}/{{ $banner_image_download['value'] ?? '' }}"
                                                                    onerror='this.src="{{ asset('/public/assets/admin/img/aspect-1.png') }}"'
                                                                    class="img__aspect-1 mw-100 min-w-135px" alt="">
                                                            </div>
                                                            <input type="file" name="banner_image_download" hidden>
