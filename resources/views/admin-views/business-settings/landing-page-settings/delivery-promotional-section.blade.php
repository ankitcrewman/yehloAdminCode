...
@section('title', 'Deliveryman Promotional')
    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.delivery-landing-page-settings', 'promotional-tab') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-12">
                                    ...
                                    <input id="title" type="text" name="main_title[]" class="form-control"
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            <img src="{{ asset('/public/assets/admin/img/upload-4.png') }}"
                ...
                @php($banners = \App\Models\DeliveryPromotion::all())
                <div class="card">
                    <div class="card-header py-2">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">Promotional List
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    $banner->image ?? '',
                                                    asset('storage/app/public/delivery_promotion') . '/' . $banner->image ?? '',
                                                    ...
                                                    <img src="{{ asset('storage/app/public/delivery_promotion') . '/' . $banner->image }}"
                                                        data-onerror-image="{{ asset('/public/assets/admin/img/upload-3.png') }}"
                                                        class="__size-105 onerror-image" alt="">
                                            </td>
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('admin.business-settings.delivery-promotional-status', [$banner->id, $banner->status ? 0 : 1]) }}"
                                            ...
                                            <td>
                                                <div class="btn--container justify-content-center">
                                                    <a class="btn action-btn btn--primary btn-outline-primary"
                                                        href="{{ route('admin.business-settings.delivery-promotional-edit', [$banner['id']]) }}">
                                                        <i class="tio-edit"></i>
                                                    </a>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.business-settings.delivery-promotional-delete', [$banner['id']]) }}"
