...
@section('content')
    <div class="content container-fluid">
        ...
        @php($banner_image_company = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'banner_image_company')->first())
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="upload-img-3 m-0">
                                                        <div class="position-relative">
                                                            <div class="img">
                                                                {{-- {{ dd(asset('storage/app/public/promotion_banner') .'/'. $banner_image_company['value'] ) }} --}}
                                                                <img src="{{ asset('storage/app/public/promotion_banner') }}/{{ $banner_image_company['value'] ?? '' }}"
                                                                    onerror='this.src="{{ asset('/public/assets/admin/img/aspect-1.png') }}"'
                                                                    class="img__aspect-1 mw-100 min-w-135px"
                                                                    alt="">
                                                            </div>
                                                            <input type="file" name="banner_image_company" hidden>
