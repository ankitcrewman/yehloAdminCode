...
@section('title',translate('messages.vendor_landing_page'))
...
<div class="content container-fluid">
    <div class="page-header pb-0">
        <div class="d-flex flex-wrap justify-content-between">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.vendor_landing_pages') }}
                </span>
            </h1>
    ...
    <div class="mb-4 mt-2">
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            @include('admin-views.business-settings.landing-page-settings.top-menu-links.vendor-landing-page-links')
        </div>
    </div>
    @php($fixed_header_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_header_title')->first())
    @php($fixed_header_sub_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_header_sub_title')->first())
    @php($fixed_module_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_module_title')->first())
    @php($fixed_module_sub_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_module_sub_title')->first())
    @php($fixed_referal_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_referal_title')->first())
    @php($fixed_referal_sub_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_referal_sub_title')->first())
    @php($fixed_newsletter_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_newsletter_title')->first())
    @php($fixed_newsletter_sub_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_newsletter_sub_title')->first())
    @php($fixed_footer_article_title=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','vendor_landing_page')->where('key','fixed_footer_article_title')->first())
    @php($fixed_link = \App\Models\DataSetting::where(['key'=>'fixed_link','type'=>'vendor_landing_page'])->first())
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active">
            <form action="{{ route('admin.business-settings.vendor-landing-page-settings', 'fixed-data') }}" method="POST">
                @csrf
                @if ($language)
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input id="fixed_footer_article_title" type="text"  maxlength="180" name="fixed_footer_article_title[]" value="{{$fixed_footer_article_title?->getRawOriginal('value')}}" class="form-control" placeholder="{{translate('Ex_:_Yehlo_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input id="fixed_footer_article_title" type="text"  maxlength="50" name="fixed_footer_article_title[]"  class="form-control" placeholder="{{translate('Ex_:_Yehlo_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="__bg-F8F9FC-card">
                        <div class="form-group mb-md-0">
                            ...
                            <!-- <input id="web_app_url" type="text" placeholder="{{translate('Ex: https://Yehlo-web.6amtech.com/')}}" class="form-control h--45px" name="web_app_url" value="{{ $fixed_link['web_app_url'] ?? ''}}"> -->
                            <input id="web_app_url" type="text" placeholder="{{translate('Ex: https://Yehlo-web.yehlo.com/')}}" class="form-control h--45px" name="web_app_url" value="{{ $fixed_link['web_app_url'] ?? ''}}">
                        </div>
                    </div>
                </div>
