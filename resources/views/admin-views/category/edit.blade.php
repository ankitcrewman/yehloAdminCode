                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group lang_form" id="default-form">
                                        ...
                                        <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_category')}}" maxlength="15" value="{{$category?->getRawOriginal('name')}}"  >
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
                                ...
                                @foreach($language as $lang)
                                    ...
                                    <div class="form-group d-none lang_form" id="{{$lang}}-form">
                                        ...
                                        <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_category')}}" maxlength="15" value="{{$translate[$lang]['name']??''}}"  >
                                    </div>
