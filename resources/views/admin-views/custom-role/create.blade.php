                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.users.custom-role.create') }}" method="post">
                            ...
                            <div class="d-flex flex-wrap select--all-checkes">
                                <h5 class="input-label m-0 text-capitalize">{{ translate('messages.Set_permission') }} :
                                </h5>
                            ...
                            <div class="check--item-wrapper">
                                ...
                                {{-- create Refeeral code --}}

                                <div class="check-item">
                                    <div class="form-group form-check form--check">
                                        <input type="checkbox" name="modules[]" value="referral_code" class="form-check-input"
                                            id="reff">
                                        <label class="form-check-label qcont text-dark"
                                            for="reff">Create Refferal Code</label>
                                    </div>
                                </div>
                                ...
                                <tbody id="set-rows">
                                    @foreach ($roles as $k => $role)
                                        <tr>
                                            ...
                                            <td title="{{ $role['name'] }}">{{ Str::limit($role['name'], 25, '...') }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('admin.users.custom-role.delete', [$role['id']]) }}"
