                    ...
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <label class="text-center my-auto position-relative d-inline-block">
                            <img class="img--176 border" id="viewer" @if(isset($category))
                                src="{{asset('storage/app/public/plan')}}/" @else
            ...
            <table class="table table-borderless table-thead-bordered table-align-middle">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0 w--1">{{ translate('messages.plan_duration') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$plan->id}}">
                                <input type="checkbox"
                                    data-url="{{route('admin.plan.status',[$plan['id'],$plan->status?0:1])}}"
                                    class="toggle-switch-input redirect-url" id="stocksCheckbox{{$plan->id}}"
                                    {{$plan->status?'checked':''}}>
                        ...
                        <td>
                            <label class="toggle-switch toggle-switch-sm" for="recommendedCheckbox{{$plan->id}}">
                                <input type="checkbox"
                                    data-url="{{route('admin.plan.recommend',[$plan['id'],$plan->recommed?0:1])}}"
                                    class="toggle-switch-input redirect-url" id="recommendedCheckbox{{$plan->id}}"
                        ...
                        <td>
                            <div class="btn--container justify-content-center">
                                ...
                                <a class="btn action-btn btn--danger btn-outline-danger form-alert" href="javascript:"
                                    ...
                                    title="{{translate('messages.delete_plan')}}"><i class="tio-delete-outlined"></i>
                                </a>
