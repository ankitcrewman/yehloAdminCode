    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.top-banner.store') }}" method="post" id="top_banner_form">
                            @csrf
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    @if ($language)
                            ...
                            <form class="search-form">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" type="search"
                                        value="{{ request()->get('search') ?? '' }}" name="search" class="form-control"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.top-banner.edit', [$banner['id']]) }}"
...
@push('script_2')
    ...
    <script>
        ...
        $('#top_banner_form').on('submit', function(e) {
            e.preventDefault();
            ...
            $.post({
                url: "{{ route('admin.top-banner.store') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(data) {
                    if (data.errors) {
                        ...
                        setTimeout(function() {
                            location.href = '{{ route('admin.top-banner.add-new') }}';
                        }, 2000);
                    }
                }
            });
