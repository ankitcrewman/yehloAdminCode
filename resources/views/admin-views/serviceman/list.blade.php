...
@section('title',translate('messages.serviceman'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>{{translate('messages.serviceman')}}</span>
            </h1>
        </div>
        <!-- End Page Header -->
        <!-- Card -->
        <div class="card">
            ...
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-end">
                    <h5 class="card-title mr-auto">
                        {{translate('messages.serviceman_list')}}
                        {{-- <span class="badge badge-soft-dark ml-2" id="itemCount">{{$servicemen->total()}} --}}
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tbody id="set-rows">
                    @foreach($servicemen as $key=>$dm)
                        <tr>
                            <td>{{$key+$servicemen->firstItem()}}</td>
                            <td>
                                <a class="table-rest-info" href="{{route('admin.users.delivery-man.preview',[$dm['id']])}}">
                                    ...
                                    <div class="info">
                                        <h5 class="text-hover-primary mb-0">{{$dm['first_name'].' '.$dm['last_name']}}</h5>
                            ...
                            <td>
                                <a class="deco-none" href="tel:{{$dm['phone_number']}}">{{$dm['phone_number']}}</a>
                            </td>
                            {{-- <td>
                                @if($dm->zone)
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    <a class="btn action-btn btn--primary btn-outline-primary" href="{{route('admin.service.edit',[$dm['id']])}}" title="{{translate('messages.edit')}}"><i class="tio-edit"></i>
                                        </a>
                                    ...
                                    <form action="{{route('admin.service.delete',[$dm['id']])}}" method="post" id="delivery-man-{{$dm['id']}}">
                                        @csrf @method('delete')
                                    </form>
                                </div>
                            </td>
