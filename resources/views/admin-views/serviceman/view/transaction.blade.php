        ...
        <div class="card mb-3 mb-lg-5 mt-2">
            <div class="card-header flex-wrap py-2 border-0 gap-2">
                <div class="search--button-wrapper">
                    ...
                    <div class="min--260">
                        <input type="date" class="form-control set-filter" placeholder="{{ translate('mm/dd/yyyy') }}" data-url="{{route('admin.service.preview',['id'=>$deliveryMan->id, 'tab'=> 'transaction'])}}" data-filter="date" value="{{$date}}">
                    </div>
                </div>
                <!-- Unfold -->
