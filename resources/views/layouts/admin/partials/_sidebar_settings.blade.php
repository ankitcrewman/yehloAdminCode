        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs sidebar-custom-bg">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                {{-- <li
                                    ...
                                    <a class="nav-link "
                                        ...
                                        title="{{ translate('messages.vendor_landing_page_settings') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/new-plan*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link " href="{{ route('admin.new-plan') }}" "
                ...
                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.business-settings.referrals.index') }}"
