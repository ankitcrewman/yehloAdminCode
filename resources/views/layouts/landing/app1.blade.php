...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        ...
        href="{{asset('public/assets/landing/img/yehlo-app-faviocn.png')}}">
                ...
                <div class="navbar-bottom-wrapper">
                    <a href="index.php" class="logo">
                        <img class="onerror-image"
                            ...
                            src="{{ asset('public/assets/landing/img/yehloapplogo.png')}}"
                            alt="image">
                    </a>
                    <!-- <ul class="menu">
                        <li>
                        ...
                        <li>
                            <a href="#" class><span>Privacy
                                    policy</span></a>
                        </li>
                        <li>
                            <a href="#" class><span>Terms and
                                    condition</span></a>
                        </li>
                        <li>
                    ...
                    <div class="dropdown--btn-hover position-relative">
                        <a class="dropdown--btn border-0 px-3 header--btn text-capitalize d-flex"
        ...
        <div class="container">
            <div class="newsletter-wrapper">
                <div class="newsletter-content position-relative">
                    ...
                    <form method="post" action="https://Yehlo-admin.#.com/newsletter/subscribe">
                        <input type="hidden" name="_token" value="b0kXypYvvQtNbZ9QbEd2T9BDGxlALEfMGzyJabHK"
                            autocomplete="off">
                        <div class="input--grp">
            ...
            <div class="footer-wrapper ps-xl-5">
                <div class="footer-widget">
                    <div class="footer-logo">
                        <a class="logo">
                            <img class="onerror-image" src=" {{ asset( 'public/assets/landing/img/YhloWhite.png') }}" alt="image">
                        </a>
                    </div>
                ...
                <div class="footer-widget">
                    <h5 class="subtitle mt-2 text-white">Suppport</h5>
                    <div class="txt">
                        Yehlo is a complete package! It&#039;s time to empower your multivendor online business
                ...
                <div class="footer-widget widget-links">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{route('cancelation')}}">Cancelation Policy</a>
                        </li>
                    </ul>
                </div>
                <!-- <div class="footer-widget widget-links">
                    ...
                    <ul>
                        ...
                        <li>
                            <a
                                href="https://Yehlo-admin.#.com/cdn-cgi/l/email-protection#44373134342b3630047225293021272c6a272b29">
                                ...
                                <span class="__cf_email__"
                                    data-cfemail="ddaea8adadb2afa99debbcb0a9b8beb5f3beb2b0">[email&#160;protected]</span>
                            </a>
                        </li>
                        <li>
...
<!-- Mirrored from Yehlo-admin.#.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2024 06:27:07 GMT -->
