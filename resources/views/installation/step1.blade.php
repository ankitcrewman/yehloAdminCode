...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Yehlo Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Yehlo Software Installation"
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <!-- <a href="https://docs.6amtech.com/docs-six-am-mart/intro" class="d-flex align-items-center gap-1"
                  ...
                  <a href="https://docs.yehlo.com/docs-six-am-mart/intro" class="d-flex align-items-center gap-1"
                   target="_blank">
                    Read Documentation
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                          data-bs-title="Follow our documentation">
