...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::post('login-mobile', 'CustomerAuthController@login_mobile');
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::group(['prefix' => 'vendor'], function () {
            ...
            Route::get('getplandetails', 'VendorLoginController@getplandetails');
            Route::post('purchase-plan', 'VendorLoginController@purchase_plan');    //
        });
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('/service_config', 'ConfigController@configuration_service');
        ...
        Route::get('distance-api-range', 'ConfigController@distance_api_range');
