...
use App\Http\Controllers\Admin\StoreReferralController;


Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    // Route::get('/new-plan', 'Admin\NewPlan\NewPlanController@index')->name('new-plan');
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'service', 'as' => 'service.'], function () {
            ...
            Route::get('/service-man/preview', 'ServicemanController@preview')->name('preview');
        });
        ...
        Route::post('/add-plan', 'NewPlanController@create')->name('add-plan');
        Route::post('/get-plan-variation-details', 'NewPlanController@get_plan_by_id')->name('get-plan-variation-details');
        Route::get('/plan/{id}/status/{status}', 'NewPlanController@updateStatus')->name('plan.status');
        Route::get('/plan/{id}/recommend/{status}', 'NewPlanController@updateRecommendation')->name('plan.recommend');
        Route::post('/plan/updateValue', 'NewPlanController@updateValue')->name('plan.updateValue');
        Route::get('/plan/{id}/edit', 'NewPlanController@edit')->name('plan.edit');

        Route::delete('/plan/{id}', 'NewPlanController@destroy')->name('plan.delete');



        //   refferal code

        // Route::get('referrals', [StoreReferralController::class, 'index'])->name('referrals.index');
        // Route::post('referrals/create', [StoreReferralController::class, 'create'])->name('referrals.create');
        // Route::post('referrals', [StoreReferralController::class, 'store'])->name('referrals.store');
        // Route::get('referrals/{id}', [StoreReferralController::class, 'show'])->name('referrals.show');
        // Route::get('referrals/{id}/edit', [StoreReferralController::class, 'edit'])->name('referrals.edit');
        // Route::put('referrals/{id}', [StoreReferralController::class, 'update'])->name('referrals.update');
        // Route::delete('referrals/{id}', [StoreReferralController::class, 'destroy'])->name('referrals.destroy');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::get('pages/vendor-landing-page-settings/{tab?}', 'BusinessSettingsController@vendor_landing_page_settings')->name('vendor-landing-page-settings');
            Route::POST('pages/vendor-landing-page-settings/{tab}', 'BusinessSettingsController@update_vendor_landing_page_settings')->name('vendor-landing-page-settings');
